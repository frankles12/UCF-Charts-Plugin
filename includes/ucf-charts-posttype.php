...
?>          <!-- Info Point 2 -->
            ...
            $('#typeSelector').on('click', 'a', function () {
                if ($(this).hasClass("static")) {
                    ...
                    $("#staticInput").show();
                    $("#dynamicInput").hide();
                    $("#typeSelector").html('<a href="#" class="dynamic">Dynamic File</a> | Static File');
                }
                if ($(this).hasClass("dynamic")) {
                  ...
                  $("#staticInput").hide();
                  $("#dynamicInput").show();
                    $("#typeSelector").html('Dynamic File | <a href="#" class="static">Static File</a>');
            ...
            <table class="form-table">
                ...
                <tr id="dynamicInput">
                    ...
                    <td>
                        ...
                        <p class="hide-if-no-js">
                        <form action="#">
                            Direct Upload <input type="text" name="directLink"><br>
                ...
                <tr>
                    <th><hr><strong>Chart Options JSON</strong></th>
                    <td>
                        <hr>
                        <div class="options-json-preview meta-file-wrap <?php echo empty( $options_json ) ? ' hidden' : ''?>">
                            <span class="dashicons dashicons-media-code"></span>
